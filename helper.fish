...
if test -z "STARTER_GIT_ORGA"; set -gx STARTER_GIT_ORGA "arangodb-helper"
if test -z "ENTERPRISE_GIT_HOST"; set -gx ENTERPRISE_GIT_URL "github.com"
if test -z "ENTERPRISE_GIT_ORGA"; set -gx ENTERPRISE_GIT_ORGA "arangodb"
