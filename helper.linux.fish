...
set -gx UBUNTUBUILDIMAGE_40_TAG 24
...
set -gx UBUNTUBUILDIMAGE_312_TAG 24
...
set -gx UBUNTUPACKAGINGIMAGE2 arangodb/ubuntupackagearangodb-$ARCH:4
...
set -gx CENTOSPACKAGINGIMAGE_TAG 5
...
function validateDockerImageIfNeeded
  ...
  if test "$RUN_CVE_CHECKS_FOR_DOCKER_IMAGE" = "1"; or test "$RUN_CVE_CHECKS_FOR_DOCKER_IMAGE" = "On"
    set -xg DOCKER_API_VERSION "1.41"
