...
function buildUbuntuBuildImage3
  ...
  and docker build $IMAGE_ARGS --pull -t $UBUNTUBUILDIMAGE3 .
  popd
end
...
function buildUbuntuBuildImage4
  ...
  and docker build $IMAGE_ARGS --pull -t $UBUNTUBUILDIMAGE4 .
  or begin ; popd ; return 1 ; end
  popd
end
...
function buildUbuntuBuildImage5
  ...
  and docker build $IMAGE_ARGS --pull -t $UBUNTUBUILDIMAGE5 .
  or begin ; popd ; return 1 ; end
  popd
end
...
function buildUbuntuPackagingImage
  ...
  and docker build $IMAGE_ARGS --pull -t $UBUNTUPACKAGINGIMAGE .
...
function buildAlpineBuildImage3
  ...
  and docker build $IMAGE_ARGS --pull -t $ALPINEBUILDIMAGE3 .
  or begin ; popd ; return 1 ; end
  popd
end
...
function buildAlpineBuildImage4
  ...
  and docker build $IMAGE_ARGS --pull -t $ALPINEBUILDIMAGE4 .
  or begin ; popd ; return 1 ; end
  popd
end
...
function buildAlpineBuildImage5
  ...
  and docker build $IMAGE_ARGS --pull -t $ALPINEBUILDIMAGE5 .
  or begin ; popd ; return 1 ; end
  popd
end
...
function buildAlpineUtilsImage
  ...
  and docker build $IMAGE_ARGS --pull -t $ALPINEUTILSIMAGE .
  or begin ; popd ; return 1 ; end
  popd
end
...
function buildCentosPackagingImage
  ...
  and docker build $IMAGE_ARGS --pull -t $CENTOSPACKAGINGIMAGE .
...
function buildCppcheckImage
  ...
  and docker build $IMAGE_ARGS --pull -t $CPPCHECKIMAGE .
  or begin ; popd ; return 1 ; end
  popd
end
...
function buildLdapImage
  ...
  and docker build $IMAGE_ARGS --pull -t $LDAPIMAGE .
  or begin ; popd ; return 1 ; end
  popd
end
