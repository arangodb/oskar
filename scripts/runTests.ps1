...
Function global:registerClusterTests()
{
    ...
    registerTest -cluster $true -testname "dump_export"
    ...
    registerTest -cluster $true -testname "recovery" -index "0" -bucket "4/0" "arangosearch"
    registerTest -cluster $true -testname "recovery" -index "1" -bucket "4/1" "arangosearch"
    registerTest -cluster $true -testname "recovery" -index "2" -bucket "4/2" "arangosearch"
    registerTest -cluster $true -testname "recovery" -index "3" -bucket "4/3" "arangosearch"
