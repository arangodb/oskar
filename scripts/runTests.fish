...
set ST "$ST""750,runSingleTest1 shell_api http $EncryptionAtRest --ssl false -\n"
set ST "$ST""750,runSingleTest1 shell_api https $EncryptionAtRest --ssl true -\n"
...
set ST "$ST""500,runSingleTest1 shell_fuzzer -\n"
