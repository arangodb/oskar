...
Function global:registerClusterTests()
{
    ...
    registerTest -testname "recovery_cluster" -index "0" -bucket "4/0" "arangosearch"
    registerTest -testname "recovery_cluster" -index "1" -bucket "4/1" "arangosearch"
    registerTest -testname "recovery_cluster" -index "2" -bucket "4/2" "arangosearch"
    registerTest -testname "recovery_cluster" -index "3" -bucket "4/3" "arangosearch"
