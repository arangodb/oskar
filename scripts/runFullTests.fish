...
set ST "$ST""750,runSingleTest1 shell_client http -\n"
...
set СT "$СT""2000,runClusterTest1 recovery 0 --testBuckets 4/0 --test arangosearch\n"
set СT "$СT""2000,runClusterTest1 recovery 1 --testBuckets 4/1 --test arangosearch\n"
set СT "$СT""2000,runClusterTest1 recovery 2 --testBuckets 4/2 --test arangosearch\n"
set СT "$СT""2000,runClusterTest1 recovery 3 --testBuckets 4/3 --test arangosearch\n"
