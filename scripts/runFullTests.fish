...
if test -f $INNERWORKDIR/ArangoDB/tests/test-definitions.txt
  ...
  $INNERWORKDIR/ArangoDB/scripts/generateJenkinsScripts.py $INNERWORKDIR/ArangoDB/tests/test-definitions.txt -f fish --full | source
else
  ...
  hasLDAPHOST; and set ST "$ST""2000,runSingleTest1 ldaprole - --ldapHost $LDAPHOST --ldap2Host $LDAPHOST2\n"
  hasLDAPHOST; and set ST "$ST""2000,runSingleTest1 ldaprolesimple - --ldapHost $LDAPHOST --ldap2Host $LDAPHOST2\n"
  hasLDAPHOST; and set ST "$ST""2000,runSingleTest1 ldapsearch - --ldapHost $LDAPHOST --ldap2Host $LDAPHOST2\n"
  hasLDAPHOST; and set ST "$ST""2000,runSingleTest1 ldapsearchsimple - --ldapHost $LDAPHOST --ldap2Host $LDAPHOST2\n"
  hasLDAPHOST; and set ST "$ST""2000,runSingleTest1 ldapdualldap - --ldapHost $LDAPHOST --ldap2Host $LDAPHOST2\n"
  hasLDAPHOST; and set ST "$ST""2000,runSingleTest1 ldapfirstldap - --ldapHost $LDAPHOST --ldap2Host $LDAPHOST2\n"
  hasLDAPHOST; and set ST "$ST""2000,runSingleTest1 ldapsecondldap - --ldapHost $LDAPHOST --ldap2Host $LDAPHOST2\n"
  ...
  set ST "$ST""750,runSingleTest1 shell_api https --protocol ssl $EncryptionAtRest -\n"
  ...
  isENTERPRISE; and set ST "$ST""500,runSingleTest1 shell_client_aql encrypt $EncryptionAtRest -\n"
  set ST "$ST""1000,runSingleTest1 shell_fuzzer -\n"
  ...
  set ST "$ST""1000,runSingleTest1 communication -\n"
  set ST "$ST""1000,runSingleTest1 communication_ssl -\n"
...
if test -f $INNERWORKDIR/ArangoDB/tests/test-definitions.txt
  echo "Using test definitions from arangodb repo"
  $INNERWORKDIR/ArangoDB/scripts/generateJenkinsScripts.py $INNERWORKDIR/ArangoDB/tests/test-definitions.txt -f fish --full --cluster | source
else
  ...
  set CT "$CT""750,runClusterTest1 resilience_move_view - --dumpAgencyOnError true\n"
  set CT "$CT""500,runClusterTest1 resilience_repair - --dumpAgencyOnError true\n"
  set CT "$CT""750,runClusterTest1 resilience_failover - --dumpAgencyOnError true\n"
  set CT "$CT""500,runClusterTest1 resilience_failover_failure - --dumpAgencyOnError true\n"
  ...
  set CT "$CT""2500,runClusterTest1 shell_client_aql - --dumpAgencyOnError true\n"
  set CT "$CT""1000,runClusterTest1 shell_fuzzer - --dumpAgencyOnError true\n"
  set CT "$CT""500,runClusterTest1 authentication 0 --testBuckets 3/0 --dumpAgencyOnError true\n"
  ...
  set CT "$CT""1000,runClusterTest1 communication - --dumpAgencyOnError true\n"
  set CT "$CT""1000,runClusterTest1 communication_ssl - --dumpAgencyOnError true\n"
  ...
  set CT "$CT""250,runClusterTest1 wal_cleanup -\n"
