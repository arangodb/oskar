...
set ST "$ST""750,runSingleTest1 shell_api http --ssl false $EncryptionAtRest -\n"
...
set CT "$CT""500,runClusterTest1 shell_api http --ssl false $EncryptionAtRest -\n"
set CT "$CT""500,runClusterTest1 shell_api https --ssl true $EncryptionAtRest -\n"
