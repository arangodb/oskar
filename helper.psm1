...
{
    checkoutIfNeeded
    (Get-Content $global:WORKDIR\work\ArangoDB\CMakeLists.txt) -replace '"set\(ARANGODB_VERSION_RELEASE_TYPE .*"', 'set(ARANGODB_VERSION_RELEASE_TYPE "nightly"' | Out-File $global:WORKDIR\work\ArangoDB\CMakeLists.txt
}
