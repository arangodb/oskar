...
openssl req -new -key server.key -subj "/C=DE/ST=NRW/L=Cologne/O=ArangoDB GmbH/OU=Clifton/CN=ldap01.arangodb.biz/emailAddress=hackers@arangodb.com/" -out server.csr
openssl req -new -key client.key -subj "/C=DE/ST=NRW/L=Cologne/O=ArangoDB GmbH/OU=Clifton/CN=ldap01.arangodb.biz/emailAddress=hackers@arangodb.com/" -out client.csr
